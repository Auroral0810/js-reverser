...
cookies = {
    ...
    'Hm_lpvt_b5d072258d61ab3cd6a9d485aac7f183': '1744099003',
}
...
for i in range(1,21):
    ...
    response = requests.get('https://stu.tulingpyton.cn/api/problem-detail/1/data/', params=params, cookies=cookies, headers=headers).json()["current_array"]
