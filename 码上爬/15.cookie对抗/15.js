...
function D() {
    var n = O();
    return Qn.setCookie(Fn, n, o[248], A, t[215]), //设置cookie
    Zn.set(jn, n), //设置header中的"hexin-v"
    n
}
