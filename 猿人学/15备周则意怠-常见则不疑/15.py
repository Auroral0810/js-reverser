...
cookies = {
    ...
    'Hm_lpvt_9bcbda9cbf86757998a2339a0437208e': '1744046914',
    'Hm_lpvt_c99546cf032aaa5a679230de9a95c7db': '1744046957',
}
...
for i in range(1,6):
    ...
    print(params)
    response = requests.get('https://match.yuanrenxue.cn/api/match/15', params=params, cookies=cookies, headers=headers).json()['data']
