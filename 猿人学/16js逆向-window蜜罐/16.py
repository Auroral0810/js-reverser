...
cookies = {
    ...
    'yuanrenxue_cookie': '1744029937|t8BX6BHsEx7jPD49Kdld7X3pEEctDahpzeqh08TUMlQkwC9SwCDBI5HOGGjzwxB3NoCOeGXepLM9sctU',
    'Hm_lpvt_9bcbda9cbf86757998a2339a0437208e': '1744030281',
    'Hm_lpvt_c99546cf032aaa5a679230de9a95c7db': '1744030358',
}
...
headers = {
    ...
    # 'cookie': 'sessionid=a0san8v13c61zw435r31r0zpq62xafx5; Hm_lvt_c99546cf032aaa5a679230de9a95c7db=1744004527; HMACCOUNT=764A7B05229BE584; Hm_lvt_434c501fe98c1a8ec74b813751d4e3e3=1744004548; Hm_lpvt_434c501fe98c1a8ec74b813751d4e3e3=1744004548; HMACCOUNT=764A7B05229BE584; Hm_lvt_9bcbda9cbf86757998a2339a0437208e=1744004555; no-alert3=true; tk=-6834914907875830726; yuanrenxue_cookie=1744029937|t8BX6BHsEx7jPD49Kdld7X3pEEctDahpzeqh08TUMlQkwC9SwCDBI5HOGGjzwxB3NoCOeGXepLM9sctU; Hm_lpvt_9bcbda9cbf86757998a2339a0437208e=1744030281; Hm_lpvt_c99546cf032aaa5a679230de9a95c7db=1744030358',
}

time = (int)(time.time())*1000
with open('16_1.js', 'r') as f:
    js_code = f.read()
ctx = execjs.compile(js_code)
sum = 0
for i in range(1, 6):
    m = ctx.call('btoa', str(time))
    params = {
        'page': i,
        'm': m,
        't': time,
    }
    response = requests.get('https://match.yuanrenxue.cn/api/match/16', params=params, cookies=cookies, headers=headers).json()["data"]
