...
_0x4e96b4 = global
_0x30bc70 = String;
_$yw = String(parseInt(new Date().getTime()))
console.log(_$yw);
...
_0x3b2c8e = Function;
_0x1171c8 = 0x67452301;
_0x4dae05 = -0x10325477;
_0x183a1d = -0x67452302;
_0xcfa373 = 0x10325476;
_0x4e96b4['_$qF'] = CryptoJS['enc']['Utf8']['parse'](btoa(_0x4e96b4['_$is']).slice(0, 16));
_0xceb4b2 = []
...
function getCookieM(_$yw) {
    return _0x474032(_$yw)
}
function getTimeM(_$yw){
    return _$yw;
}
function RM4hZBv0dDon443M(_$yw, pr){
    var value = Buffer.from(_$yw).toString('base64').slice(0, 16);
...
function get_cookies(){
    ...
    return {
        "m_cookie": pr[4],
        "RM4hZBv0dDon443M": RM4hZBv0dDon443M(_$yw, pr.toString()),
...
console.log(getCookieM());
console.log(_0x474032('1744125242280'));
console.log(getTimeM());
// 1744125242280
// 5eeef760ce0d2ea0754f4f8b552a7c1d