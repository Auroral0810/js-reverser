...
cookies = {
    ...
    'Hm_lpvt_9bcbda9cbf86757998a2339a0437208e': '1744045194',
    'Hm_lpvt_c99546cf032aaa5a679230de9a95c7db': '1744045202',
}
...
for i in range(1,6):
    ...
    response = requests.get('https://match.yuanrenxue.cn/api/match/19', cookies=cookies, headers=headers,params=params)
    print(response.text)
