...
dt = 'y3B5WlQ6pvNABgEFABeWPA4y9c7rG2tZ'
id = '07e2387ab53a4d6f930b8d9a9be71bdf'
cb = ctx.call('getCB')
cookies = {
    '_ga': 'GA.1.27f5963b48389.c23e3fde15e036b8e77a',
    ...
    '_qddaz': 'QD.415944659252012',
    'Hm_lvt_4671c5d502135636b837050ec6d716ce': '1744659251,1744706224,1744718220,1744724532',
    'HMACCOUNT': '764A7B05229BE584',
    'Hm_lpvt_4671c5d502135636b837050ec6d716ce': '1744725054',
}
...
headers = {
    ...
    # 'Cookie': '_ga=GA.1.27f5963b48389.c23e3fde15e036b8e77a; _ntes_nnid=20e442659d79d6c0a6d8c7aa82074f90,1713420636872; _ntes_nuid=20e442659d79d6c0a6d8c7aa82074f90; _ga=GA1.1.1492695192.1720416908; _clck=1b0kmll%7C2%7Cfna%7C0%7C1650; _ga_PTGVM6PCHS=GS1.1.1720416907.1.1.1720416967.0.0.0; NTES_P_UTID=vdw2AldMLX7G1OaMM0r0NecnctFFlope|1736655377; P_INFO=18114461685|1744534562|1|music|00&99|null&null&null#jis&320100#10#0|&0||18114461685; hb_MA-93D5-9AD06EA4329A_source=www.google.com; __root_domain_v=.163.com; _qddaz=QD.415944659252012; Hm_lvt_4671c5d502135636b837050ec6d716ce=1744659251,1744706224,1744718220,1744724532; HMACCOUNT=764A7B05229BE584; Hm_lpvt_4671c5d502135636b837050ec6d716ce=1744725054',
}
...
def get_captcha_data():
    params = {
        ...
        'zoneId': 'CN31',
        'dt': dt,
        'irToken': "C746Gxo+N+9AdxEQRROXaA7cBBrUNfXq",
        'id': id,
        'fp': '5mc8l2ilRsGdQOxeOAPbIvla5r+zLmU+o/UwnX6upQxJODmnMuKq0bA3ZGEz0OiQ1UuTdvO/fRpWDhOke/2dl5Wu1+srZ9mEDSTGsTxVnUfZ6x5p6tV4\\8pudvrQxUT4r8eyIIi1amy9YhM4Ym/0+mbc\\d9Uu\\6GOLKKQ04/BejgmpZ3:1744725433777',
        'https': 'true',
        'type': '2',
        'version': '2.28.5',
        'dpr': '2',
        'dev': '1',
        'cb': ctx.call('getCB'),  # 每次请求生成新的cb
        'ipv6': 'false',
        'runEnv': '10',
        'group': '',
        'scene': '',
        ...
        'smsVersion': 'v3',
        'token': '',
        'callback': f'__JSONP_qecyd6i_{random.randint(1, 100)}',
    }
